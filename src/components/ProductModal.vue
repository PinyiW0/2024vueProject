                      ...
                      <div class="mb-2">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control"
                                 placeholder="請輸入圖片連結" id="imageUrl" v-model="curProduct.imageUrl">
                        </div>
                      ...
                      <div>
                        ...
                        <div v-if="Array.isArray(tempProduct.imagesUrl)">
                          <div v-for="(img, key) in tempProduct.imagesUrl" :key="key + 123">
                            ...
                            <input type="text" class="form-control mb-3" v-model="curProduct.imagesUrl[key]"> <!-- 綁索引位置才能在替換圖片網址時換成相對應位置的圖 -->
                          </div>
                          ...
                          <button class="btn btn-outline-danger mb-3 d-block w-100"
                            v-else @click.prevent="curProduct.imagesUrl.pop()">
                            刪除圖片
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="col-sm-8">
                      ...
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          ...
                          <input id="category" type="text" class="form-control"
                                 placeholder="請輸入分類" v-model="curProduct.category">
                        </div>
                        <div class="mb-3 col-md-6">
                      ...
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          ...
                          <input id="origin_price" type="number" min="0" class="form-control" placeholder="請輸入原價"  v-model="curProduct.origin_price">
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="price" class="form-label">售價</label>
                          <input id="price" type="number" min="0" class="form-control"
                                 placeholder="請輸入售價" v-model="curProduct.price">
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea id="description" type="text" class="form-control"
                                  placeholder="請輸入產品描述" v-model="curProduct.description">
                    </textarea>
                      </div>
                      <div class="mb-3">
                        <label for="content" class="form-label">說明內容</label>
                        <textarea id="description" type="text" class="form-control"
                                  placeholder="請輸入說明內容" v-model="curProduct.content">
                    </textarea>
                      </div>
                      <div class="mb-3">
                        <div class="form-check">
                          <input id="is_enabled" class="form-check-input" type="checkbox"
                                 :true-value="1" :false-value="0"  v-model="curProduct.is_enabled">
